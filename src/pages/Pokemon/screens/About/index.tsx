  ...
  return (
    <SectionAbout colorText={colorText}>
      ...
      {pokemonSpecie.descriptionPok}
        {/*Texte aléatoire pour remplir un champ avec des mots aléatoires pour un
        pokémon aléatoire. Un tel texte a été écrit et pensé au hasard,
        votre seul objectif est de remplir cette information manquante avec des mots.
        caractères aléatoires jusqu'à ce que vous obteniez une bonne quantité de caractères aléatoires.*/}
