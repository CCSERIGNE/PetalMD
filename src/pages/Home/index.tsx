...
const Home: React.FC = () => {
  ...
  // Filtre les pokémons à partir de la chaîne saisie dans l'entrée de recherche
  const handleSearchPokemons = useCallback(async () => {
    ...
    // Valider les noms de pokemon apparaissent dans la valeur de la variable de recherche pokemon
  ...
  // Charger une liste de démarrage de pokémons
  ...
  useEffect(() => {
    // La recherche n'est effectuée que lorsque la chaîne comporte 2 caractères ou plus.
  ...
  // Ajouter de nouveaux pokémons à la liste
